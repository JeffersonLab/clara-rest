...
from clara.rest.Container.models import Container
from clara.rest.DPE.models import Node
from clara.rest.DPE.serializers import NodeSerializer
from clara.rest.Service.models import ServiceEngine


"""
clara Views:
Views for json responses for the Clara clara (DPE) components
"""
...
class Dpes(APIView):
    ...
    def post(self, request):
        ...
        response_serializer: clara.serializers.NodeSerializer
        responseMessages:
            - code: 400
              message: Bad Request
            - code: 401
