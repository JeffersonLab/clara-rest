...
from backend.monitoring.message_helpers import RuntimeMsgHelper, RegistrationMsgHelper
...
class DpeMonitorCallBack(xMsgCallBack):
    ...
    def __init__(self, db_host):
        self.client = InfluxDBClient(host=db_host, database="claraRuntime")
    ...
    def callback(self, msg):
        ...
        """
        self.save_runtime_data(msg)
        self.save_registration_data(msg)
        return msg

    def save_runtime_data(self, msg):
        ...
        self.client.write_points(points=points, tags=tags)
    ...
    def save_registration_data(self, msg):
